...
module.exports = {
  ...
  datastores: {
    ...
    ***************************************************************************/
    default: {
      ...
      ****************************************************************************/
      adapter: 'sails-mongo',
      //url:'mongodb://dbWapchita:KPxFJegMupDEgPj1@osomroom.6fdec.mongodb.net:27017/Osom?authSource=admin&appname=MongoDB%20Compass&ssl=true',
      ...
      url:'mongodb://dbWapchita:KPxFJegMupDEgPj1@cluster0-shard-00-02.gzft4.mongodb.net:27017,cluster0-shard-00-01.gzft4.mongodb.net:27017,cluster0-shard-00-00.gzft4.mongodb.net:27017/Osom?ssl=true&replicaSet=cluster0-shard-0&authSource=admin&appname=MongoDB%20Compass&retryWrites=true&w=majority',
      ssl: true,
    ...
    ***************************************************************************/
    cors: {
      allowOrigins: [
        'http://localhost:3000',
        'http://localhost:8080',
        'https://wapchita-osom.herokuapp.com',
        'https://rooms-osom.wapchita.com',
        'https://wapchita-dezurda.herokuapp.com',
        'https://wapchita-osom-backend.herokuapp.com',
        'https://osomcommerce.com',
      ],
      allowRequestHeaders: 'content-type,access-control-allow-origin',
  ...
  ***************************************************************************/
  custom: {
    ...
    //--------------------------------------------------------------------------
    // Osom
    chatApiInstanceUrl: 'https://eu76.chat-api.com/instance182883/',
    chatApiInstanceToken: '08wm1u3d1m2icrce'

    // De Zurda
    // chatApiInstanceUrl: 'https://eu169.chat-api.com/instance188355/',
    // chatApiInstanceToken: 'k0zt6ryvezikdvfb'

    // Test
    // chatApiInstanceUrl: 'https://eu109.chat-api.com/instance181007/',
    // chatApiInstanceToken: 'wpnsxrkg2c0nq0q8'
  },
